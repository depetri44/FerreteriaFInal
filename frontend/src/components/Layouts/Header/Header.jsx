...
const Header = () => {
  ...
  return (
    ...
    <header className="bg-white fixed top-0 py-2.5 w-full z-10">
      ...
      <div className="w-full sm:w-9/12 px-1 sm:px-4 m-auto flex justify-between items-center relative">
        ...
        <div className="flex items-center justify-between ml-1 sm:ml-0 gap-0.5 sm:gap-7 relative">
          ...
          {isAuthenticated === false ?
            <Link to="/login" className="px-3 sm:px-9 py-0.5 text-white bg-primary-yellow border font-medium rounded-sm cursor-pointer">Ingresar</Link>
            :
            (
