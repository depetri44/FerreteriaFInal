...
const MainData = () => {
    ...
    const lineState = {
        ...
        datasets: [
            {
                label: `Ventas en ${date.getFullYear() - 2}`,
                borderColor: '#8A39E1',
            ...
            {
                label: `Ventas en ${date.getFullYear() - 1}`,
                borderColor: 'orange',
            ...
            {
                label: `Ventas en ${date.getFullYear()}`,
                borderColor: '#4ade80',
    ...
    return (
        <>
            <MetaData title="Panel de Administración | Ferreteria Pitty" />

            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-6">
                <div className="flex flex-col bg-purple-600 text-white gap-2 rounded-xl shadow-lg hover:shadow-xl p-6">
                    <h4 className="text-gray-100 font-medium">Totales de Ventas</h4>
            ...
            <div className="flex flex-col sm:flex-row justify-between gap-3 sm:gap-8 min-w-full">
                ...
                <div className="bg-white rounded-xl shadow-lg p-4 text-center">
                    <span className="font-medium uppercase text-gray-800">Estado del Pedido</span>
                    <Pie data={pieState} />
                </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row justify-between gap-3 sm:gap-8 min-w-full mb-6">
                ...
                <div className="bg-white rounded-xl shadow-lg p-4 text-center">
                    <span className="font-medium uppercase text-gray-800">Estado de Stock</span>
