...
const UpdateUser = () => {
    ...
    return (
        <>
            <MetaData title="Admin: Update User | Ferreteria Pitty" />
                    ...
                    <div className="flex flex-col bg-white shadow-lg rounded-lg mx-auto w-lg max-w-xl">
                        ...
                        >
                            <div className="flex flex-col gap-3 items-start">
                                ...
                                <button type="submit" className="text-white py-3 w-full bg-black shadow hover:shadow-lg rounded-sm font-medium">Update</button>
