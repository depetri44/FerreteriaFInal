...
const UpdateProduct = () => {
    ...
    return (
        <>
            <MetaData title="Admin: Update Product | Ferreteria Pitty" />
            ...
            <form onSubmit={newProductSubmitHandler} encType="multipart/form-data" className="flex flex-col sm:flex-row bg-white rounded-lg shadow p-4" id="mainform">
                ...
                <div className="flex flex-col gap-3 m-2 sm:w-1/2">
                    ...
                    <div className="flex flex-col gap-2">
                        <div className="flex justify-between items-center border rounded">
                            ...
                            <span onClick={() => addHighlight()} className="py-2 px-6 bg-black text-white rounded-r hover:shadow-lg cursor-pointer">Add</span>
                        </div>
                ...
                <div className="flex flex-col gap-2 m-2 sm:w-1/2">
                    ...
                    <div className="flex justify-evenly gap-2 items-center">
                        ...
                        <span onClick={() => addSpecs()} className="py-2 px-6 bg-black text-white rounded hover:shadow-lg cursor-pointer">Add</span>
                    </div>
                    ...
                    <div className="flex justify-end">
                        <input form="mainform" type="submit" className="bg-black uppercase w-1/3 p-3 text-white font-medium rounded shadow hover:shadow-lg cursor-pointer" value="Update" />
                    </div>
